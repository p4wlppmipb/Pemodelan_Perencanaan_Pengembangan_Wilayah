# =========================================================
# MODEL MAKSIMISASI ENTROPI KLASIK
...
model <- glm(
  flow ~ origin + destination + distance,
...
# =========================================================
# 9. ORIGIN & DESTINATION COEFFICIENTS
# =========================================================
...
write_csv(final_output, "entropy_glm_sigma_delta_r2_output.csv")
